...
HD_PWD='C:/Users/recep/Adder_7_Segment_Display/Adder_7_Segment_Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_mux_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex_mux_test.tcl
