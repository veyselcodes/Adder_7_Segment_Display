...
HD_PWD='C:/Users/recep/Adder_7_Segment_Display/Adder_7_Segment_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_mux_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex_mux_test.tcl -notrace
